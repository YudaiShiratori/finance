# Generated by Django 3.0.3 on 2020-02-17 03:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('fiscal_year', models.DateField(verbose_name='決算日\xa0')),
                ...
                ('cf_operating', models.IntegerField(default=0, verbose_name='営業利益（百万円）')),
                ('cf_investment', models.IntegerField(default=0, verbose_name='投資CF（百万円）')),
                ('cf_finance', models.IntegerField(default=0, verbose_name='財務CF（百万円）')),
